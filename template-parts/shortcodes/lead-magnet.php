...
<section class="absolute inset-0 z-20" id="hy-lead-magnet-section">
    ...
    <button class="float-right cursor-pointer opacity-50 hover:opacity-100 sm:hidden -translate-x-3 translate-y-3" onclick="leadMagnet();"><?= get_svg('icon-cross', 'w-8 h-8 my-svg-white'); ?></button>
